...
STANDARD_COLORS = [
    'Aqua',  'Beige', 'Chocolate',  'Gold', 'Khaki','LightBlue',
    'Magenta',  'Orange','Pink','Purple', 'Red',  'Green', 
...
def draw_bounding_box_on_image(current_frame_number,image,
  ...
  #predicted_color = 'red' #color_recognition_api.color_recognition(detected_vehicle_image)
  ...
  # instead of above.
  display_str_list[0] = str(predicted_speed) + " " + display_str_list[0] ## changed here...
  csv_line = "No_Color" + "," + str (predicted_direction) + "," + str(predicted_speed) # csv line created
...
def visualize_boxes_and_labels_on_image_array(current_frame_number,image,
  ...
  for box, color in box_to_color_map.items():
    ...
    if (("car" in display_str_list[0]) or ("truck" in display_str_list[0]) or ("bus" in display_str_list[0]) or ("bike" in display_str_list[0])):
