...
def predict_speed(
    ...
    speed = 'n.a.'  # initial numbers
    direction = 'n.a.'  # initial numbers
    scale_constant = 1  # manual scaling to negate camera calibration
    ...
    if len(bottom_position_of_detected_vehicle) != 0 and bottom \
        ...
        update_csv = True
        fname = image_saver.save_image(crop_img)  # save detected vehicle image
    ...
    if isInROI:
        ...
        if scale_real_time_passed != 0:
            ...
            speed = round(speed / 6 * 20,1) # use reference constant to get vehicle speed prediction in kilometer unit
